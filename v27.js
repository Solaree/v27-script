...
var SERVER_CONNECTION = 0xbe95a8;
var NEW_OPERATOR = 0x7ba26d;
var WAKEUP_RETURN_ARRAY = [0xb620c, 0x31bb94, 0x33b42c, 0x48a590, 0x59ee5c, 0x63e8d8];
var PTHREAD_COND_WAKE_RETURN = 0x79a0c3;
var CREATE_MESSAGE_BY_TYPE = 0x30eadc;
var SELECT_RETURN = 0x11b4e4;
var POINTER_SIZE = 4;
...
Memory.writeU16(args[1].add(2), ntohs(9339)); // port
...
function onReceive() {
    ...
    if (messageType === 20104) {
        var prod = cache.base.add(0x2FDB34)
        Memory.protect(prod, 1, "rwx") 
        prod.writeU8(0)
